...
Base URL for Better Auth. This is typically the root URL where your application server is hosted. Note: If you provide a path in the baseURL (e.g. including "/my-auth" in the URL), the default "/api/auth" path will be ignored and your specified path will be used instead.
